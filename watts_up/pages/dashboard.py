...
def update_main_plot(selected_state, selected_trend):
    ...
    if selected_trend == 'energy-trend':    
        ...
        plot.update_yaxes(title_text='MWh')
        ...
        long_df = pd.melt(filtered_df, id_vars=['year'], value_vars=['total_average_price', 'commercial_price', 'indusrial_price','residential_price'],
